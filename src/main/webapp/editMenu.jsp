...
<%=restaurant.getRestaurantId()==menu.getRestaurantId() ? "selected" : ""%>>
...
<%=menu.getCategory().equals("Starter") ? "selected" : ""%>>
...
<%=menu.getCategory().equals("Main Course") ? "selected" : ""%>>
...
<%=menu.getCategory().equals("Biryani") ? "selected" : ""%>>
...
<option value="Pizza"
<%=menu.getCategory().equals("Pizza") ? "selected" : ""%>>
...
<option value="Burger"
<%=menu.getCategory().equals("Burger") ? "selected" : ""%>>
...
<%=menu.getCategory().equals("Chinese") ? "selected" : ""%>>
...
<%=menu.getCategory().equals("South Indian") ? "selected" : ""%>>
